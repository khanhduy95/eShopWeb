...
namespace eShopWeb.Core.Entities
{
    public abstract class BaseEntity
    {
        ...
        public virtual string CreateBy { get; protected set; } = null;
        public virtual DateTime? CreateAt { get; protected set; } 
        public virtual string UpdateBy { get; protected set; } = null;
        public virtual DateTime? UpdateAt { get; protected set; }
        public virtual string DeleteBy { get; protected set; } = null;
